...
the public [`update-php-dependencies.yml`](.github/workflows/update-php-dependencies.yml)
...
TypeScript/npm releases publish via npm [trusted publishing][npm-trusted-publishing]
