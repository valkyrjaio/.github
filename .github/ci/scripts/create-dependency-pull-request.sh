...
# moved.
#
# Reads GH_TOKEN, BASE, BRANCH, TITLE, SUMMARY, and EMPTY_MESSAGE from the
# environment. NOUN is the heading of the table's first column, and a caller
...
# whose update script records no version change leaves NOUN unset, and the body
# then carries EMPTY_MESSAGE.
#
# Usage:
#
